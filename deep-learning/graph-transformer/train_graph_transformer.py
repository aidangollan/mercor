...
Usage (from command line with torchrun when not on macOS):
    torchrun --nproc_per_node=8 train_graph_transformer.py --epochs 200 --lr 0.01 --dataset clout

Usage (on macOS):
    python train_graph_transformer.py --macos --epochs 100 --lr 0.01 --dataset clout
"""
